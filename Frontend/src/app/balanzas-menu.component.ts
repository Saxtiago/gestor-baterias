    ...
    <section class="menu-layout">
      <div class="menu-main">
        ...
        <section class="menu-grid">
          <a class="menu-card" routerLink="/modulos/balanzas/agregar">
            <h2>Agregar</h2>
            <p>Registrar una nueva balanza.</p>
          </a>

          <a class="menu-card" routerLink="/modulos/balanzas/listar">
            <h2>Buscar / Listar</h2>
            <p>Consultar balanzas registradas.</p>
          </a>
          ...
          <a class="menu-card" routerLink="/modulos/balanzas/editar">
            <h2>Editar</h2>
            <p>Modificar informacion existente.</p>
          </a>

          <a class="menu-card" routerLink="/modulos/balanzas/eliminar">
            <h2>Eliminar</h2>
      ...
      <aside class="attention-card">
        <div class="attention-head">
          <h2>Atencion hoy</h2>
          <a routerLink="/modulos/balanzas/listar">Ver en listado</a>
        </div>
        <p class="empty" *ngIf="isLoadingDashboard">Cargando indicadores...</p>
        <p class="empty" *ngIf="!isLoadingDashboard && attentionItems.length === 0">Sin balanzas por vencer.</p>
...
export class BalanzasMenuComponent implements OnInit {
  protected readonly exportBaseUrl = `${environment.apiBaseUrl}/api/balanzas/export`;
  private readonly listUrl = `${environment.apiBaseUrl}/api/balanzas?all=1`;
  private readonly syncUrl = `${environment.apiBaseUrl}/api/balanzas/sync`;
  ...
  private loadDashboard(): void {
    ...
    this.http.get<RegistroApi[]>(this.listUrl).pipe(
      ...
      next: (rows) => {
        ...
        this.totalRegistros = mapped.length;
